...
- performance: high
- output_file: .ai/features/04-project-chart-compare-with-benchmark/03_review.md
- result_json_file: .ai/features/04-project-chart-compare-with-benchmark/03_review.result.json
- run_state: .ai/runs/04-project-chart-compare-with-benchmark/run.json
- generated_at: 2026-06-05T01:04:36
- defaults_mode: true
...
3. Write the human-readable stage output file exactly at `.ai/features/04-project-chart-compare-with-benchmark/03_review.md`.
4. Also write the machine-readable stage result JSON exactly at `.ai/features/04-project-chart-compare-with-benchmark/03_review.result.json`.
...
The harness reads `.ai/features/04-project-chart-compare-with-benchmark/03_review.result.json` first. Keep the `## 단계 결과` section in `.ai/features/04-project-chart-compare-with-benchmark/03_review.md` for humans, but write this JSON file for the harness.
...
## Current Git Hints
- current_head: 8272c3055e12e280c239f49568c3903e253a671b
...
8. 리뷰 결과를 `.ai/features/04-project-chart-compare-with-benchmark/03_review.md`에 작성한다.
...
리뷰 완료 후 `.ai/features/04-project-chart-compare-with-benchmark/03_review.md`에 아래 형식으로 작성한다.
