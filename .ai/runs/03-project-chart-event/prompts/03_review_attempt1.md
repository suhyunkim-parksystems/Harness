...
- performance: medium
- output_file: .ai/features/03-project-chart-event/03_review.md
- result_json_file: .ai/features/03-project-chart-event/03_review.result.json
- run_state: .ai/runs/03-project-chart-event/run.json
- generated_at: 2026-06-04T23:47:36
- defaults_mode: true
...
3. Write the human-readable stage output file exactly at `.ai/features/03-project-chart-event/03_review.md`.
4. Also write the machine-readable stage result JSON exactly at `.ai/features/03-project-chart-event/03_review.result.json`.
...
The harness reads `.ai/features/03-project-chart-event/03_review.result.json` first. Keep the `## 단계 결과` section in `.ai/features/03-project-chart-event/03_review.md` for humans, but write this JSON file for the harness.
...
## Current Git Hints
- current_head: 2a00545bb85b0476cb6d79ba52647ab1ce92e4e9
...
8. 리뷰 결과를 `.ai/features/03-project-chart-event/03_review.md`에 작성한다.
...
리뷰 완료 후 `.ai/features/03-project-chart-event/03_review.md`에 아래 형식으로 작성한다.
